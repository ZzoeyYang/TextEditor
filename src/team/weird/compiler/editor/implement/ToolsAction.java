...
import team.weird.compiler.editor.util.BrowserUtil;
...
//	private JWebBrowser browser;
	...
	public void translation() {
		...
		try {
			if(source != null){
				...
				TextState.translateResult.setText("      Source: "+source + "        Target£º " + result);
				Timer timer = new Timer(5000 * result.length(), new ActionListener(){
	...
	public void surfTheInternet() {
		...
		SwingUtilities.invokeLater(new Runnable(){
			@Override
			public void run() {
				Browser br = new Browser("http://www.baidu.com/");
			}
		});
...
//		        frame.getContentPane().add(new BrowserUtil(), BorderLayout.CENTER);  
